...
const placeOfBirthInput = document.getElementById("place-of-birth-input");
...
const updateFirstNameInput = document.getElementById("update-first-name-input");
const updatePlaceOfBirthInput= document.getElementById("update-place-of-birth-input");
...
function renderTable() {
  ...
  for (let i = 0; i < users.length; i++) {
    ...
    placeOfBirthTd.innerText= user.placeOfBirth;
...
function addUser() {
  ...
  if(email.match(validRegex)){
    if(name && firstName && placeOfBirth && email != null){
      var id = 1;
...
function updateUser() {
  ...
  const placeOfBirth = updatePlaceOfBirthInput.value;
  ...
  if(email.match(validRegex)){
    ...
    if (index !== -1) {
      ...
      users[index].placeOfBirth = placeOfBirth;
...
function showUpdateForm(userId) {
  ...
  if (user) {
    ...
    updatePlaceOfBirthInput.value = user.placeOfBirth;
    ...
    updateFirstNameInput.display = "inline-block";
    updateDateOfBirthInput.style.display = "inline-block";
...
function hideUpdateForm() {
  ...
  updateFirstNameInput.style.display = "none";
  updatePlaceOfBirthInput.style.display = "none";
